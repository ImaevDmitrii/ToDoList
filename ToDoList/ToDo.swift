...
struct ToDo: Equatable, Codable {
    ...
    static let documentirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
    static let archiveURL = documentirectory.appendingPathComponent("toDos")
